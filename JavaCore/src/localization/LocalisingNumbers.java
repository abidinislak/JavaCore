...
//        System.out.println(NumberFormat.getNumberInstance(Locale.FRANCE).format(n));// 77 000,11
        ...
        System.err.println(NumberFormat.getNumberInstance(Locale.TAIWAN).format(n));
        System.err.println(NumberFormat.getInstance(Locale.GERMANY).format(n));
        System.err.println(NumberFormat.getInstance(Locale.FRENCH));
    }
    ...
    public static void formatCurrencies() {
        ...
        System.err.println(NumberFormat.getCurrencyInstance(Locale.TAIWAN).format(n));
        System.err.println(NumberFormat.getCurrencyInstance(Locale.ITALY).format(n));
